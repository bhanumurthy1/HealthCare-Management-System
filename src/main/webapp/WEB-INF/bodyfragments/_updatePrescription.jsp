	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item text-indigo-800 linkSize active" aria-current="page">
				<i class="fa fa-arrow-right text-indigo-800" aria-hidden="true">Add Prescription
				</i> </li>
		</ol>
	</nav>
</div>
...
<div class="container">
	<sf:form method="post"
		action="${pageContext.request.contextPath}/appointment/updatePrescription"
			...
			<div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width: 1000px" >
			  <div class="md:flex w-full">
				<div class="hidden md:block w-1/3 bg-indigo-500 py-10 px-10">
					...
					<img
					src="${pageContext.request.contextPath}/resources/images/prescription.svg"
					class=" h-full w-full "
					alt="..."
				  />
				</div>
				<div class="bg-white  w-full md:w-2/3 py-10 px-5 md:px-10">
					...
					<h1 class="font-bold text-2xl text-gray-900">Add Prescription</h1><br></br>
				...
				<div class="mb-3">
					<div class="row">
						<div class="col-md-6">
							<s:bind path="prescription">
								<div class="relative mb-6">
									<div class="relative">
								<label for="inputEmail4" class="absolute text-sm text-black dark:text-black duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-gray-100 dark:bg-gray-300 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Prescription<font color="red">*</font></label>
