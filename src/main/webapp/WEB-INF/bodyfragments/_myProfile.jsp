	...
	<sf:form method="post"
		...
		<div class="card">
			<h5 class="card-header"
				style="background-color: rgb(13 110 253/ 25%); color: black;"> My Profile</h5>
			<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<s:bind path="insuranceDetail">
								...
								<sf:input path="${status.expression}"
									placeholder="Enter InsuranceDetail here..." class="form-control" />
								<font color="red" style="font-size: 13px"><sf:errors
										path="${status.expression}" /></font>
							</s:bind>
						</div>
						...
						<div class="col-md-4">
							<s:bind path="insuranceCarrierName">
								...
								<sf:input path="${status.expression}"
									placeholder="Enter InsuranceCarrierName here..." class="form-control" />
								<font color="red" style="font-size: 13px"><sf:errors
										path="${status.expression}" /></font>
							</s:bind>
						</div>
			...
			<div class="mb-3">
				...
				<div class="mb-3">
					<div class="row">
						<div class="col-md-6">
							<img alt="" width="150px" height="150px" src="<c:out value="${pageContext.request.contextPath}/user/getProfilePic/${sessionScope.user.id}" />">
						</div>
					</div>
				</div>
						...
						<div class="col-md-6">
							<s:bind path="profilePic">
								...
								<sf:input type="file" path="${status.expression}"
									placeholder="Upload Profile Picture" class="form-control" required="required" />
								<font color="red" style="font-size: 13px"><sf:errors
										path="${status.expression}" /></font>
							</s:bind>
						</div>
						...
						<div class="col-md-6">
							<s:bind path="address">
								...
								<sf:textarea path="${status.expression}"
									placeholder="Enter Address here..." rows="4" cols="4" class="form-control" />
								<font color="red" style="font-size: 13px"><sf:errors
										path="${status.expression}" /></font>
							</s:bind>
						</div>
