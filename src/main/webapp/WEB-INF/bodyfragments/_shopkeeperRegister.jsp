	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item text-indigo-800 linkSize active" aria-current="page">
				<i class="fa fa-arrow-right text-indigo-800" aria-hidden="true">Shopkeeper 
				Registration</i>
			</li>
		</ol>
	</nav>
			...
			<div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width: 1000px" >
			  <div class="md:flex w-full">
				<div class="hidden md:block w-1/3 bg-indigo-500 py-10 px-10">
					...
					<img
					src="${pageContext.request.contextPath}/resources/images/shopkeeper.svg"
					class=" h-full w-full "
					alt="..."
				  />
				</div>
				<div class="bg-white  w-full md:w-2/3 py-10 px-5 md:px-10">
					...
					<h1 class="font-bold text-2xl text-gray-900">Shopkeeper Registration</h1><br></br>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<s:bind path="shopName">
								...
								<sf:input path="${status.expression}" class="block px-2.5 pb-2.5 pt-2 w-full text-sm text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" />
