					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<p class="mb-1">${orderDetail.userOrderBilling.firstName} ${orderDetail.userOrderBilling.lastName}</p>
								<p>${orderDetail.userOrderBilling.email}</p>
								<p class="mb-1">${orderDetail.userOrderBilling.state},${orderDetail.userOrderBilling.city},${orderDetail.userOrderBilling.address}</p>
								<p class="mb-1">${orderDetail.userOrderBilling.zipCode}</p>
							</div>
						</div>
						<hr class="my-5">
						<div class="row ">
