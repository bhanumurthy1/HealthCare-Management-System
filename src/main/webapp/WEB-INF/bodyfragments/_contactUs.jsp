...
<div class="shadow-sm  mb-5 bg-body rounded">
  <div class="jumbotron" style="background-color:rgb(13 110 253 / 25%);padding: 15px;">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <legend><span class="glyphicon glyphicon-globe"></span> Our office</legend>
             <address>
                <strong>SUNY Albany</strong><br>
                <strong>Location: </strong>
                Albany, New York<br>
                <abbr title="Phone">
                  <strong>  Phone No:</abbr></strong>
                +1 (838) 202-8930
            </address>
            <address>
                <strong>Mailing Address:</strong><br>
                <a href="mailto:#">healthcaremanagementhms@gmail.com</a>
            </address>
            </form>
        </div>
    </div>
